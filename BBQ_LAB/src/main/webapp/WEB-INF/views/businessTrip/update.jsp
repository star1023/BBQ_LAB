...
<script type="text/javascript">
	...
	function fn_previewDataBinding(popup) {
	    ...
	    $doc.title = document.getElementById("title").value + '_출장결과보고서';
...
<div class="wrap_in" id="fixNextTag">
	...
	<section class="type01">
		<h2 style="position:relative">
			<span class="title_s">Design Change Report</span><span class="title">출장결과보고서 수정</span>
								...
								<table width="100%">
									...
									<tbody id="user_tbody" name="user_tbody">
										...
										<tr id="user_tr_${status.count}">
											<td>
												<input type="text" name="dept" id="dept" style="width: 100%;" class="req" value="${userList.DEPT}" readonly/>
											</td>
											<td>
												<input type="text" name="position" id="position" style="width: 100%;" class="req" value="${userList.POSITION}" readonly/>
											</td>
											<td>
												<input type="text" name="name" id="name" style="width: 100%;" class="req" value="${userList.NAME}" readonly/>
											</td>
											<td>
												<ul>
								...
								<table width="100%">
									...
									<tbody id="contents_tbody" name="contents_tbody">
										...
										<tr id="contents_tr_${status.count}">
											<td>
												<input type="text" name="schedule" id="schedule" style="width: 90%;" class="req" value="${contentsList.SCHEDULE}" readonly/>
											</td>
											<td>
										...
										<tr id="contents_tr_1">
											<td>
												<input type="text" name="schedule" id="schedule" style="width: 90%;" class="req" readonly/>
											</td>
											<td>
