...
<div class="wrap_in" id="fixNextTag">
	...
	<section class="type01">
		<h2 style="position:relative">
			<span class="title_s">Design Change Report</span><span class="title">상품설계변경보고서 개정</span>
			...
			<div class="main_tbl">
				<table class="insert_proc01">
					...
					<c:forEach items="${addInfoList}" var="addInfoList" varStatus="status">
						...
						<tr id="changeReason_tr_${count}">
							<td>
								<input type="checkbox" id="changeReason_${status.count}"><label for="changeReason_${status.count}"><span></span></label>
							</td>
							<td>
								<input type="text"  style="width:99%; float: left" class="req" name="changeReason" value="${addInfoList.INFO_TEXT}"/>
							</td>
						</tr>
						</c:if>
					</c:forEach>
			...
			<div class="main_tbl">
				<table class="insert_proc01">
					...
					<c:forEach items="${addInfoList}" var="addInfoList" varStatus="status">
						...
						<c:set var="count" value="${count + 1}" />
						<tr id="changeTime_tr_${count}">
							<td>
								<input type="checkbox" id="changeTime_${count}"><label for="changeTime_${count}"><span></span></label>
							</td>
							<td>
								<input type="text"  style="width:99%; float: left" class="req" name="changeTime" value="${addInfoList.INFO_TEXT}"/>
							</td>
						</tr>
						</c:if>
					</c:forEach>
