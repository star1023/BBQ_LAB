...
<script type="text/javascript">
	...
	function fn_pdfDownload(idx) {
	    ...
	    fetch("/preview/packageInfoViewPopup?idx=" + idx)
	        .then(function(res) {
	            return res.text();
	        })
	        .then(function(html) {
	            ...
	            var src = img.getAttribute("src");
	                ...
	                var trimmedSrc = src.trim(); // ✅ 줄바꿈 제거
	                var absoluteSrc = trimmedSrc.startsWith("http") ? trimmedSrc : location.origin + trimmedSrc;
	            ...
	            Promise.all(imagePromises).then(function() {
	                ...
	                formData.append("docType", "PACKAGE");
	                formData.append("userId", "${userId}");
	                formData.append("title", "${packageInfoData.data.PRODUCT_NAME}_표시사항기재양식");
	                ...
	                fetch("/preview/downloadPdf", {
	                    ...
	                    .then(function(blob) {
	                        ...
	                        a.href = url;
	                        a.download = "${packageInfoData.data.PRODUCT_NAME}_메뉴품질점검결과보고서.pdf";
	                        a.click();
