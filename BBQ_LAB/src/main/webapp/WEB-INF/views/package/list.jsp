...
<script type="text/javascript">
	...
	function fn_loadList(pageNo) {
		var URL = "../package/selectPackageInfoListAjax";
	...
	function fn_insert() {
		window.location.href = "../package/insert";
	}
	...
	function fn_viewHistory(idx, docNo) {
		var URL = "../package/selectHistoryAjax";
		$.ajax({
			type:"POST",
			url:URL,
			data:{
...
<div class="wrap_in" id="fixNextTag">
	<span class="path">표시사항 기재양식&nbsp;&nbsp;
		<img src="/resources/images/icon_path.png" style="vertical-align:middle"/>&nbsp;&nbsp;
		<a href="#">${strUtil:getSystemName()}</a>
	</span>
	<section class="type01">
	<!-- 상세 페이지  start-->
		<h2 style="position:relative"><span class="title_s">Package Info</span>
			<span class="title">표시사항 기재양식</span>
			<div  class="top_btn_box">
				<ul>
					<li>
						<button type="button" class="btn_circle_red" onClick="javascript:fn_insert();">&nbsp;</button>
					</li>
				</ul>
			</div>
		</h2>
		<div class="group01" >
			...
			<div class="btn_box_con"> 
				<button class="btn_admin_red" onclick="javascript:fn_insert();">표시사항 생성</button>
			</div>
