...
<div class="wrap_in" id="fixNextTag">
	...
	<section class="type01">
		<h2 style="position:relative">
			<span class="title_s">Market Research Report</span><span class="title">시장조사결과보고서 등록</span>
							...
							<td colspan="3">
								<table width="100%" border="0">
									<tbody id="market_tbody" name="market_tbody">
										<tr id="market_tr_1">
											<td>
												<input type="text"  style="width:90%; float: left" name="marketName" id="marketName" placeholder="가."/>
											</td>
										</tr>
									</tbody>
