    ...
    doc.write(
      '<html>' +
        '<head>' +
          ...
          '<style>@media print { body { margin: 10px; } a { text-decoration: none; color: black; }}</style>' +
        '</head>' +
		...
		<div class="mainTable">
			<table  >
				...
				<tbody>
					...
					<tr>
						<th  >제품명</th>
						<td colspan="3"><span id="prev_productName" ></span></td>
					</tr>
					<tr>
						<th  >공동 참여자</th>
					...
					<tr>
						<th  >개발 목적</th>
						<td colspan="3" id="prev_purpose">
						</td>
					</tr>
					<tr>
						<th  >제품 특징</th>
						<td colspan="3" id="prev_feature">
						</td>
					</tr>
					<tr>
						<th  >브랜드</th>
