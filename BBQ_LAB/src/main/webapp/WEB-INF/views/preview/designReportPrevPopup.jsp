...
<body>
	...
	<div id="wrapper">
		...
		<div class="mainTable">
			<table >
				...
				<tbody>
					...
					<tr>
						<th  >변경사유</th>
						<td colspan="3" id="prev_changeReason">
						</td>
					</tr>
					<tr>
						<th  >변경사항</th>
					...
					<tr>
						<th >변경 적용 시점</th>
						<td colspan="3" id="prev_changeTime">
		...
		<div id="wrapper_prev_content" style="display:none;">
			...
			<table>
				<tr>
					<td><div id="prev_content" style="white-space: pre-wrap; word-wrap: break-word;"></div></td>
				</tr>
			</table>
		</div>
	</div>
