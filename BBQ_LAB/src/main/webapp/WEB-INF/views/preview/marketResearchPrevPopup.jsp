		...
		<div class="mainTable">
			<table  >
				...
				<tbody>
					<tr>
						<th >제목</th>
						<td colspan="3" id="prev_title">
							${researchData.data.TITLE}
						</td>
					</tr>
					<tr>
						<th  >출장구분</th>
						<td colspan="3" id="prev_trip_type">
						</td>
					</tr>
					<tr>
						<th  >대상업소</th>
						<td colspan="3" id="prev_market_tbody">
						</td>
					</tr>
					<tr>
						<th  >목적</th>
						<td colspan="3" id="prev_purpose_tbody">					
						</td>
					</tr>
					<tr>
						<th  >일시</th>
						<td colspan="3" id="prev_researchDate">
						</td>
					</tr>
					<tr>
						<th  >주소</th>
						<td colspan="3" id="prev_address_tbody">
						</td>
					</tr>
					<tr>
						<th  >비용</th>
						<td colspan="3" >
							<p style="white-space: pre-line; text-align:left;" id="prev_cost"></p>
						</td>
					</tr>
					<tr>
						<th  >조사자</th>
