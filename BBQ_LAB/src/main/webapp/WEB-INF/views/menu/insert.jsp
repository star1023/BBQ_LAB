...
<script type="text/javascript">
	...
	function fn_searchErpMaterial(pageType) {
		...
		console.log($('#searchErpMatValue').val());
		if(!pageType)
...
//	          UL이 아직 갱신되기 전이라 누락될 수 있으니 보강
		...
		(() => {
		  ...
		  var $mul = document.getElementById("manual_attatch_file"); // 메뉴얼 UL
...
<div class="wrap_in" id="fixNextTag">
	...
	<section class="type01">
		<h2 style="position:relative">
			<span class="title_s">Menu Complete Doc</span><span class="title">메뉴완료보고서 등록</span>
		...
		<div class="group01 mt20">
			...
			<div id="tab1_div">
				...
				<!-- ========================= 메뉴얼 첨부 (새 섹션) ========================= -->
				<div class="title2 mb20"  style="width:90%;"><span class="txt">메뉴얼 첨부</span></div>
				<div class="list_detail">
				  <ul>
				    <li>
				        ...
				        <div class="add_file" style="width:100%">
				          <span>
				            ...
				            <span class="file_load" id="manualFileSpan">
				              ...
				              <label for="manual_file1">메뉴얼 등록 <img src="/resources/images/icon_add_file.png"></label>
				            </span>
				          </span>
				        </div>
					...
					<table id="matTable" class="tbl05">
						...
						<tbody id="newMatTbody" name="newMatTbody">
							<Tr id="newMatRow_1" class="temp_color">
								...
								<td>
									<input type="text" name="itemSapCode" style="width: 100px" readonly="readonly" class="read_only"/>
								</td>
								<td>
					...
					<table id="matTable" class="tbl05">
						...
						<tbody id="matTbody" name="matTbody">
							<tr id="matRow_1" class="temp_color">
								...
								<td>
									<input type="hidden" name="itemMatIdx" style="width: 100px" class="code_tbl" />
									<input type="text" name="itemMatCode" style="width: 100px" class="code_tbl read_only" readonly="readonly"/>
								</td>
								<td>
									<input type="text" name="itemSapCode" style="width: 100px" onkeyup="checkMaterail(event,'mat')" />
...
<table id="tmpMatTable" class="tbl05" style="display:none">
	...
	<tbody id="tmpMatTbody2" name="tmpMatTbody2">
		<tr id="tempMatRow_1" class="temp_color">
			...
			<td>
				<input type="hidden" name="itemMatIdx" style="width: 100px" class="code_tbl" />
				<input type="text" name="itemMatCode" class="read_only" style="width: 100px" class="code_tbl" readonly="readonly"/>
			</td>
			<td>
				<input type="text" name="itemSapCode" style="width: 100px" onkeyup="checkMaterail(event,'mat')"/>
				<button class="btn_code_search2" onclick="openMaterialPopup(this,'mat')"></button>
...
<div class="white_content" id="dialog_search">
	<div class="modal" style="	width: 700px;margin-left:-360px;height: 550px;margin-top:-300px;">
		<h5 style="position:relative">
			<span class="title">메뉴완료보고서 검색</span>
			<div  class="top_btn_box">
				<ul>
					<li>
