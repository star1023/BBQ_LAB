...
.insert_proc01 > tbody#testItemsTbody td{
	...
	$(document).ready(function(){
		$("#requestDate").datepicker({
			...
			onClose: function(selectedDate){
				$("#completionDate").datepicker("option", "minDate", selectedDate);
			}
		...
		$("#completionDate").datepicker({
			...
			showAnim: "",
			onClose: function(selectedDate){
				$("#requestDate").datepicker("option", "maxdate", selectedDate)
			}
		});
...
<div class="wrap_in" id="fixNextTag">
	...
	<section class="type01">
		<h2 style="position:relative">
			<span class="title_s">Request For Chemical Test</span><span class="title">이화학 검사 의뢰서 등록</span>
