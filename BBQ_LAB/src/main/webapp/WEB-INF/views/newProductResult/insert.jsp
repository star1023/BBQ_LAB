...
<title>메뉴 품질 점검 결과 보고서 등록</title>
...
function fn_previewDataBinding(popup) {
	...
	$doc.title = document.getElementById("title").value+'_메뉴품질점검결과보고서]';
	...
	$doc.getElementById("prev_file").setAttribute("colspan", dynamicColCount);
	...
	if (inputMode !== 'upload') {
		...
		$doc.getElementById("prev_content").style.display = 'none';
	}
...
<div class="wrap_in" id="fixNextTag">
	...
	<section class="type01">
		<h2 style="position:relative">
			<span class="title_s">Menu Quality Test Report</span><span class="title">메뉴 품질 점검 결과 보고서 등록</span>
